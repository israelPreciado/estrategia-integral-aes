...
/**
 * Servlet implementation class ListadoProyectosAPI
 */
@WebServlet("/listado-proyectos")
public class ListadoProyectosAPI extends HttpServlet {
			...
			try {
				...
				if ( strApiKey == null || !apiKey.equals(strApiKey) ) {
					...
					try {
						...
						jArray = estrategiaConn.execute("listado_proyectos", xml);
